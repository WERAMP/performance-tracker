...
export default function PerformanceTracker({ initialLocTypes, initialPractices, initialLocations }) {
  ...
  useEffect(() => {
    Promise.all([
      fetch(`${BP}/data/performance/locations.json`).then(r => r.json()),
      fetch(`${BP}/data/performance/weekly-metrics.json`).then(r => r.json()),
      fetch(`${BP}/data/performance/daily-metrics.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-ops.json`).then(r => r.json()),
      fetch(`${BP}/data/performance/weekly-btx.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-budget.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-inj-rev-provider.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-btx-provider.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-ntx-filler.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-syringe-loc.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-syringe-provider.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-rev-coll-provider.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-provider-hours.json`).then(r => r.json()).catch(() => []),
      fetch(`${BP}/data/performance/weekly-utilization.json`).then(r => r.json()).catch(() => []),
